...
export default function HomePage() {
  ...
  // فلترة المنتجات بناءً على التصنيف المختار من شريط المنيو
  ...
  return (
    <main className="pb-6 space-y-8">
      {/* سكشن البانرات - بعرض الشاشة بالكامل (Edge-to-Edge) */}
      {isBannersLoading ? (
      ...
      <div className="container mx-auto px-4 space-y-12">
        <section>
          <h2 className="text-2xl font-bold mb-6">المنيو (قائمة المنتجات)</h2>
          
          {/* شريط التصنيفات (فلاتر المنيو) */}
          <div className="mb-8">
            <FoodCategories selectedCategory={selectedCategory} onSelectCategory={setSelectedCategory} />
          </div>
